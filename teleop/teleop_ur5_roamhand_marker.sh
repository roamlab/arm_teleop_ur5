...
titles[3]="ur5_roamhand_moveit_planning_execution"

cmds[4] = "rosrun teleop teleop_main.py marker_control.cfg"
titles[4]="teleop_main"

cmds[5] = "rosrun teleop_pose_marker marker_control.py"
